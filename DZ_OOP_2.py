...
best_lecturer_1 = Lecturer('Сергей', 'Петров')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Радион', 'Савельев')
best_lecturer_2.courses_attached += ['Java']

best_lecturer_3 = Lecturer('Владимир', 'Семёнов')
